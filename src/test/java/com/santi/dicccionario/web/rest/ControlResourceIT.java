...
class ControlResourceIT {
    ...
    private static final String DEFAULT_ID_CONTROL = "AAAAAAAAAA";
    private static final String UPDATED_ID_CONTROL = "BBBBBBBBBB";
    ...
    public static Control createEntity(EntityManager em) {
        Control control = new Control().idControl(DEFAULT_ID_CONTROL).nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION);
        return control;
    }
    ...
    public static Control createUpdatedEntity(EntityManager em) {
        Control control = new Control().idControl(UPDATED_ID_CONTROL).nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
        return control;
    }
    ...
    void createControl() throws Exception {
        ...
        assertThat(testControl.getIdControl()).isEqualTo(DEFAULT_ID_CONTROL);
    ...
    void getAllControls() throws Exception {
        ...
        restControlMockMvc
            ...
            .andExpect(jsonPath("$.[*].idControl").value(hasItem(DEFAULT_ID_CONTROL)))
    ...
    void getControl() throws Exception {
        ...
        restControlMockMvc
            ...
            .andExpect(jsonPath("$.idControl").value(DEFAULT_ID_CONTROL))
    ...
    void putNewControl() throws Exception {
        ...
        updatedControl.idControl(UPDATED_ID_CONTROL).nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
        ...
        Control testControl = controlList.get(controlList.size() - 1);
        assertThat(testControl.getIdControl()).isEqualTo(UPDATED_ID_CONTROL);
    ...
    void partialUpdateControlWithPatch() throws Exception {
        ...
        partialUpdatedControl.idControl(UPDATED_ID_CONTROL);
    ...
    void fullUpdateControlWithPatch() throws Exception {
        ...
        partialUpdatedControl.idControl(UPDATED_ID_CONTROL).nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION);
