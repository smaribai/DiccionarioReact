...
class ClienteResourceIT {
    ...
    private static final String ENTITY_API_URL_ID = ENTITY_API_URL + "/{idCliente}";
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).descripcion(DEFAULT_DESCRIPCION).direccion(DEFAULT_DIRECCION);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).direccion(UPDATED_DIRECCION);
        return cliente;
    }
    ...
    void createClienteWithExistingId() throws Exception {
        ...
        cliente.setIdCliente("existing_id");
        ClienteDTO clienteDTO = clienteMapper.toDto(cliente);
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            .perform(get(ENTITY_API_URL + "?sort=idCliente,desc"))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].idCliente").value(hasItem(cliente.getIdCliente())))
    ...
    void getCliente() throws Exception {
        ...
        // Get the cliente
        restClienteMockMvc
            .perform(get(ENTITY_API_URL_ID, cliente.getIdCliente()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.idCliente").value(cliente.getIdCliente()))
    ...
    void putNewCliente() throws Exception {
        ...
        // Update the cliente
        Cliente updatedCliente = clienteRepository.findById(cliente.getIdCliente()).get();
        // Disconnect from session so that the updates on updatedCliente are not directly saved in db
        em.detach(updatedCliente);
        updatedCliente.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).direccion(UPDATED_DIRECCION);
        ClienteDTO clienteDTO = clienteMapper.toDto(updatedCliente);

        restClienteMockMvc
            .perform(
                put(ENTITY_API_URL_ID, clienteDTO.getIdCliente())
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.setIdCliente(cliente.getIdCliente());

        partialUpdatedCliente.direccion(UPDATED_DIRECCION);

        restClienteMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, partialUpdatedCliente.getIdCliente())
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).descripcion(UPDATED_DESCRIPCION).direccion(UPDATED_DIRECCION);
    ...
    void patchNonExistingCliente() throws Exception {
        ...
        restClienteMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, clienteDTO.getIdCliente())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(clienteDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteCliente() throws Exception {
        ...
        // Delete the cliente
        restClienteMockMvc
            .perform(delete(ENTITY_API_URL_ID, cliente.getIdCliente()).accept(MediaType.APPLICATION_JSON))
