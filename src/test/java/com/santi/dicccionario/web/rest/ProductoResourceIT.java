...
import com.santi.dicccionario.repository.ProductoRepository;
import com.santi.dicccionario.service.dto.ProductoDTO;
import com.santi.dicccionario.service.mapper.ProductoMapper;
...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto().codigoArancelario(DEFAULT_CODIGO_ARANCELARIO).descripcion(DEFAULT_DESCRIPCION);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto().codigoArancelario(UPDATED_CODIGO_ARANCELARIO).descripcion(UPDATED_DESCRIPCION);
        return producto;
    }
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.codigoArancelario(UPDATED_CODIGO_ARANCELARIO).descripcion(UPDATED_DESCRIPCION);
    ...
    void partialUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.codigoArancelario(UPDATED_CODIGO_ARANCELARIO).descripcion(UPDATED_DESCRIPCION);
