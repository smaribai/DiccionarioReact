...
import com.santi.dicccionario.repository.ClienteRepository;
import com.santi.dicccionario.service.ClienteService;
...
/**
 * REST controller for managing {@link com.santi.dicccionario.domain.Cliente}.
 */
@RestController
@RequestMapping("/api")
public class ClienteResource {
    ...
    public ResponseEntity<ClienteDTO> createCliente(@Valid @RequestBody ClienteDTO clienteDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/clientes/" + result.getIdCliente()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getIdCliente()))
            .body(result);
    }

    /**
     * {@code PUT  /clientes/:idCliente} : Updates an existing cliente.
     *
     * @param idCliente the id of the clienteDTO to save.
    ...
    public ResponseEntity<ClienteDTO> updateCliente(
        @PathVariable(value = "idCliente", required = false) final String idCliente,
        @Valid @RequestBody ClienteDTO clienteDTO
    ) throws URISyntaxException {
        log.debug("REST request to update Cliente : {}, {}", idCliente, clienteDTO);
        if (clienteDTO.getIdCliente() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(idCliente, clienteDTO.getIdCliente())) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clienteDTO.getIdCliente()))
            .body(result);
    }

    /**
     * {@code PATCH  /clientes/:idCliente} : Partial updates given fields of an existing cliente, field will ignore if it is null
     *
     * @param idCliente the id of the clienteDTO to save.
     * @param clienteDTO the clienteDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated clienteDTO,
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/clientes/{idCliente}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ClienteDTO> partialUpdateCliente(
        @PathVariable(value = "idCliente", required = false) final String idCliente,
        @NotNull @RequestBody ClienteDTO clienteDTO
    ) throws URISyntaxException {
        log.debug("REST request to partial update Cliente partially : {}, {}", idCliente, clienteDTO);
        if (clienteDTO.getIdCliente() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        if (!Objects.equals(idCliente, clienteDTO.getIdCliente())) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, clienteDTO.getIdCliente())
        );
    }
