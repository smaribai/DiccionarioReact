...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './producto-controles.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOCONTROLES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOCONTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOCONTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOCONTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOCONTROLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOCONTROLES actions', async () => {
      const expectedActions = [
        {
