...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOCLIENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOCLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOCLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOCLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOCLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOCLIENTE actions', async () => {
      const expectedActions = [
        {
