  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="diccionarioReactApp.divisa.home.createOrEditLabel" data-cy="DivisaCreateUpdateHeading">
            <Translate contentKey="diccionarioReactApp.divisa.home.createOrEditLabel">Create or edit a Divisa</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('diccionarioReactApp.divisa.codigoDivisa')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('diccionarioReactApp.divisa.nombreDivisa')}
