...
export const ProductoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="diccionarioReactApp.producto.delete.question">
        <Translate contentKey="diccionarioReactApp.producto.delete.question" interpolate={{ id: productoEntity.id }}>
