...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './control.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTROL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTROL actions', async () => {
      const expectedActions = [
        {
