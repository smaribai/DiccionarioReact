...
export const getEntities = createAsyncThunk('envio/fetch_entity_list', async ({ page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IEnvio, thunkAPI) => {
    return axios.post<IEnvio>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  'envio/update_entity',
  async (entity: IEnvio, thunkAPI) => {
    return axios.put<IEnvio>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IEnvio, thunkAPI) => {
    return axios.patch<IEnvio>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IEnvio>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
