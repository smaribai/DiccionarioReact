...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './envio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENVIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENVIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENVIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENVIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENVIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENVIO actions', async () => {
      const expectedActions = [
        {
