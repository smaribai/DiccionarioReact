  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="diccionarioReactApp.idioma.home.createOrEditLabel" data-cy="IdiomaCreateUpdateHeading">
            <Translate contentKey="diccionarioReactApp.idioma.home.createOrEditLabel">Create or edit a Idioma</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="idioma-codigo"
                  label={translate('diccionarioReactApp.idioma.codigo')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('diccionarioReactApp.idioma.nombre')}
                id="idioma-nombre"
                name="nombre"
                data-cy="nombre"
                type="text"
