...
export const ClienteDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(clienteEntity.idCliente));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="diccionarioReactApp.cliente.delete.question">
        <Translate contentKey="diccionarioReactApp.cliente.delete.question" interpolate={{ id: clienteEntity.idCliente }}>
