...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ICliente, thunkAPI) => {
    const result = await axios.put<ICliente>(`${apiUrl}/${entity.idCliente}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ICliente, thunkAPI) => {
    const result = await axios.patch<ICliente>(`${apiUrl}/${entity.idCliente}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
